...
# Dependencies
deps=(unzip linux-headers-3.16.0 dkms lsb-release linux-source)
...
then
	...
	ln -s /lib/modules/3.16.0/build/Makefile /lib/modules/3.16.0/build/Kconfig
fi
...
if [ "$lsb" == "Debian" ] || [ "$lsb" == "Kali" ];
then
	rm /lib/modules/3.16.0/build/Kconfig
fi
